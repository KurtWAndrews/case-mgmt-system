    ...
    drop table daily_log_entry if exists;

    drop table email_address if exists;

    drop table employee if exists;

    drop table firm if exists;

    drop table lawyer if exists;

    drop table lawyer_specialty if exists;

    drop table legal_case if exists;

    drop table legal_case_employee if exists;

    drop table person if exists;

    drop table person_appointment if exists;
